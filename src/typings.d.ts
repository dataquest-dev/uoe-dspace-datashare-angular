 ...
 * `src/index.html`. Called once by `AppComponent.removeSsrOverlayWhenContentVisible()` after the
 * auth/theme loader gate opens and the routed `<ds-app>` DOM has settled, to drop the SSR
